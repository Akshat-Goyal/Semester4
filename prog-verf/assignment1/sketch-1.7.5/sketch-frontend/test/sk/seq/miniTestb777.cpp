...
void desugar(srcAST* src, dstAST*& _out) {
  ...
  case NumS::NUMS_type:
    ...
    desugar(NULL, b_s23);
    int  tmp=_src->v;
    dstAST*  dstAST_=NumD::create(tmp);
    _out = dstAST_;
    return;
  ...
  case PlusS::PLUSS_type:
    ...
    dstAST*  a_s25=NULL;
    desugar(_src->b, a_s25);
    dstAST*  b_s27=NULL;
    desugar(_src->a, b_s27);
    opcode*  op=PlusOp::create();
    dstAST*  dstAST__0=BinopD::create(op, b_s27, a_s25);
    _out = dstAST__0;
    return;
  ...
  case MinusS::MINUSS_type:
    ...
    dstAST*  a_s29=NULL;
    desugar(_src->b, a_s29);
    dstAST*  b_s31=NULL;
    desugar(_src->a, b_s31);
    opcode*  op_0=MinusOp::create();
    dstAST*  dstAST__1=BinopD::create(op_0, b_s31, a_s29);
    _out = dstAST__1;
    return;
  ...
  case TrueS::TRUES_type:
    ...
    dstAST*  b_s35=NULL;
    desugar(NULL, b_s35);
    dstAST*  dstAST__2=BoolD::create(1);
    _out = dstAST__2;
    return;
  ...
  case FalseS::FALSES_type:
    ...
    dstAST*  b_s39=NULL;
    desugar(NULL, b_s39);
    dstAST*  dstAST__3=BoolD::create(0);
    _out = dstAST__3;
    return;
