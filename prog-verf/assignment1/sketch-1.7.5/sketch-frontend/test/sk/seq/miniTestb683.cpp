...
void test1__Wrapper(int x1, int x2) {
  test1(x1, x2);
}
void test1__WrapperNospec(int x1, int x2) {}
void test2__Wrapper(int x1, int x2) {
  test2(x1, x2);
}
void test2__WrapperNospec(int x1, int x2) {}
void test3__Wrapper() {
  test3();
}
...
void test4__WrapperNospec() {}
void test1(int x1, int x2) {
  srcAST*  in=PlusS::create(NumS::create(x1), NumS::create(x2));
  dstAST*  out=BinopD::create(PlusOp::create(), NumD::create(x1), NumD::create(x2));
  dstAST*  outB_s17=NULL;
  desugar(in, outB_s17);
  bool  _out_s19=0;
  equals_dstAST_s0(out, outB_s17, 6, _out_s19);
  assert (_out_s19);;
}
void test2(int x1, int x2) {
  srcAST*  in=NULL;
  in = MinusS::create(NumS::create(x1), NumS::create(x2));
  dstAST*  out=BinopD::create(MinusOp::create(), NumD::create(x1), NumD::create(x2));
  dstAST*  outB_s41=NULL;
  desugar(in, outB_s41);
  bool  _out_s43=0;
  equals_dstAST_s0(out, outB_s41, 6, _out_s43);
  assert (_out_s43);;
}
void test3() {
  srcAST*  in=TrueS::create();
  dstAST*  out=BoolD::create(1);
  dstAST*  outB_s45=NULL;
  desugar(in, outB_s45);
  bool  _out_s47=0;
  equals_dstAST_s0(out, outB_s45, 6, _out_s47);
  assert (_out_s47);;
}
void test4() {
  srcAST*  in=FalseS::create();
  dstAST*  out=BoolD::create(0);
  dstAST*  outB_s49=NULL;
  desugar(in, outB_s49);
  bool  _out_s51=0;
  equals_dstAST_s0(out, outB_s49, 6, _out_s51);
  assert (_out_s51);;
}
